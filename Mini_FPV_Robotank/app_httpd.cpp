...
void WheelAct(int nLb, int nLf, int nRb, int nRf);
...
static esp_err_t index_handler(httpd_req_t *req){
    ...
    // All buttons with background color set to orange
    page += "<p align=center> <button style='background-color:orange; width:90px; height:80px;' onmousedown=getsend('go') onmouseup=getsend('stop') ontouchstart=getsend('go') ontouchend=getsend('stop') ><b>Forward</b></button> </p>";

    page += "<p align=center>";
    page += "<button style='background-color:orange; width:90px; height:80px;' onmousedown=getsend('left') onmouseup=getsend('stop') ontouchstart=getsend('left') ontouchend=getsend('stop')><b>Left</b></button>&nbsp;";
    page += "<button style='background-color:orange; width:90px; height:80px;' onmousedown=getsend('stop') onmouseup=getsend('stop')><b>Stop</b></button>&nbsp;";
    page += "<button style='background-color:orange; width:90px; height:80px;' onmousedown=getsend('right') onmouseup=getsend('stop') ontouchstart=getsend('right') ontouchend=getsend('stop')><b>Right</b></button>";
    page += "</p>";

    page += "<p align=center><button style='background-color:orange; width:90px; height:80px;' onmousedown=getsend('back') onmouseup=getsend('stop') ontouchstart=getsend('back') ontouchend=getsend('stop') ><b>Backward</b></button></p>";
